...
import { IconBrandUnsplash, IconSparkles, IconWebhook } from '@tabler/icons-react';

import { cn } from '@/lib/utils';

export type IntegrationKind = 'unsplash' | 'ai' | 'webhooks';
...
const tileStyles: Record<IntegrationKind, string> = {
    ...
    webhooks:
        'bg-gradient-to-br from-emerald-500/15 via-teal-500/10 to-cyan-500/10 ring-emerald-500/10 dark:from-emerald-400/20 dark:via-teal-400/15 dark:to-cyan-400/10 dark:ring-white/10',
};

        ...
        <div className="relative mx-auto h-36 w-52" aria-hidden="true" data-topics-empty-visual="true">
            <div className="absolute top-8 left-1 h-[5.5rem] w-28 -rotate-[10deg] rounded-xl border border-zinc-950/10 bg-white shadow-lg shadow-zinc-950/10 dark:border-white/12 dark:bg-zinc-800 dark:shadow-none dark:ring-1 dark:ring-white/10">
                ...
                <div className="space-y-1.5 p-2.5">
                    ...
                    <div className="mt-2 h-6 rounded-md bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-400/15 dark:to-teal-400/20" />
                </div>
            </div>
            ...
            <div className="absolute top-2 left-1/2 h-28 w-32 -translate-x-1/2 rounded-xl border border-zinc-950/10 bg-white shadow-xl shadow-zinc-950/15 dark:border-white/15 dark:bg-zinc-800 dark:shadow-none dark:ring-1 dark:ring-white/15">
                ...
                <div className="space-y-2 p-3">
                    ...
                    <div className="relative mt-1 h-10 overflow-hidden rounded-lg bg-gradient-to-br from-sky-100 via-indigo-100 to-violet-100 dark:from-sky-500/20 dark:via-indigo-500/20 dark:to-violet-500/25">
                        <div className="absolute inset-x-3 top-2 h-4 rounded-full bg-white/45 blur-md dark:bg-white/15" />
